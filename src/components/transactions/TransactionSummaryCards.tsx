...
export function TransactionSummaryCards({ totalIncome, totalExpense, balance }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <Card className="bg-card shadow-card border border-primary/10">
      ...
      <Card className="bg-muted/30 shadow-card border border-primary/10">
        <CardContent className="p-4">
          <div className="text-sm text-primary font-text">Saldo</div>
          <div className={`text-2xl font-bold font-display ${balance >= 0 ? 'text-secondary' : 'text-destructive'}`}>
