...
export const AnalyticsOverview: React.FC = () => (
  <section className="w-full grid gap-8 grid-cols-1 lg:grid-cols-3 items-stretch">
    {/* Resumo financeiro */}
    <div className="flex flex-col h-full shadow-2xl rounded-2xl border-0 bg-gradient-to-br from-[--background] to-[--surface] overflow-hidden hover:scale-[1.018] transition-transform duration-250">
      <div className="bg-card/85 backdrop-blur-md pb-4 px-6 pt-6 rounded-t-2xl">
    ...
    {/* Metas */}
    <div className="flex flex-col h-full shadow-lg rounded-2xl border-0 bg-card overflow-hidden hover:scale-[1.014] transition-transform duration-250">
      <div className="pb-3 bg-card/85 backdrop-blur-md px-6 pt-5">
    ...
    {/* Investimentos */}
    <div className="flex flex-col h-full shadow-lg rounded-2xl border-0 bg-card overflow-hidden hover:scale-[1.012] transition-transform duration-250">
      <div className="pb-3 bg-card/85 backdrop-blur-md px-6 pt-5">
